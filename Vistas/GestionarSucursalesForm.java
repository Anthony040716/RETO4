...
public void recibirDatosSucursal (int idDireccion,String sucursal,String departamento,String zona,String tipoCalle,String numero1,String numero2,String numero3){
    ...
    enumTipoCalle.setSelectedItem(zona);
    enumZonas.setSelectedItem(tipoCalle);
...
public void actulizarSucursalDireccion(){
    ...
    try {
        ...
        while(rs.next()){
            int idDireccion = rs.getInt("idDirrecion");
    ...
    if (!nuevaSucursal.isEmpty()){
        ...
        try{
            ...
            while (rs.next()){
                ...
                String queryActulizarSucursal = "UPDATE sucursal SET nombreSucursal = '"+nuevaSucursal+"' WHERE idSucursal = "+idSucursal+";";
                try{
                    st.executeUpdate(queryActulizarSucursal);
                }catch (SQLException e){
